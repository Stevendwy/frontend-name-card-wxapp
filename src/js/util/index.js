...
export const URL = {
	...
	ncwxapp: "https://ncwxapp.tairanmall.com",
};
...
export function redirectURL(url, mini) {
	...
	mini=Boolean(mini);
	if (mini || /ncwxapp.tairanmall.com/.test(window.location.host)) {  //判断小程序环境
		redirectURL = URL.ncwxapp + url;
	} else {
