...
import {LoadingRound, NoMoreOrderInfo, Shady, CustomerService,FastGuide } from 'component/common';
...
import {addImageSuffix, dateUtil, handleId,hideFlag} from "js/util/index";
import {
    afterstatusDeal,
    confimStatus,
    dispatchDelivery,
...
class ShopList extends Component {
    ...
    render() {
	    ...
	    return (
            <div className="shop">
                {hideFlag && <div className="shop-top">
