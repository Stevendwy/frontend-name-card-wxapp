...
const pageApi = {
    ...
    data: {url: `${WXAPI}/shop/shopIndex`, method: "get"},
    addShop: {url: `${WXAPI}/user/saveShopCollection`, method: "post"},
    removeShop: {url: `${WXAPI}/user/removeShopCollection`, method: "get"},
    coupon: {url: `${WXAPI}/promotion/obtainCoupon`, method: "post"}
};
    ...
    render() {
        ...
        return (
            <div className="storeNotOpen">
                ...
                <div className="returnIndexButton"><a onClick={()=>{
                    e.preventDefault();
                    miniProgramLogin()
                }}>返回商城首页</a></div>
            </div>
...
export class SearchBar extends Component {
    ...
    searchJump = () => {
        //browserHistory.push("/searchResult?storeHome=true&key="+(this.value||"")+"&shop="+this.props.query.shop+(this.props.shop_attr=='biz'?"&type=biz":""))
        browserHistory.push("/searchResult?storeHome=true&key=" + (this.value || "") + "&shop=" + this.props.query.shop + (this.props.shop_attr == 3 ? "&type=3" : ""))
